...
exports.soft_majority = function (other_player_previous_move, other_player) {
    var out;
    ...
    other_player[other_player_previous_move === 0? 'cooperation_count': 'betrial_count'] += 1;
...
exports.game = function (strategy1, strategy2, iterations) {
    ...
    while (--iterations) {
        moves = [strategy1(moves[1], player2), strategy2(moves[0], player1)];
